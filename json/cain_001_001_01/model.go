...
type AcquirerAuthorisationInitiation struct {
	...
	AuthstnInitn *AcquirerAuthorisationInitiation1 `json:"AuthstnInitn"`
...
type CardTransaction15 struct {
	...
	TxDtls            *CardTransactionDetail1 `json:"TxDtls"`
...
type CardTransactionDetail1 struct {
	TxAmts         *CardTransactionAmount1 `json:"TxAmts"`
