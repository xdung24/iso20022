...
type AcquirerAuthorisationResponse struct {
	XMLName     *xml.Name                       `xml:"urn1:AcquirerAuthorisationResponse", json:"-,omitempty", bson:"-,omitempty"`
	Hdr         *Header17                       `xml:"urn1:Hdr", json:"Hdr", bson:"Hdr"`
	AuthstnRspn *AcquirerAuthorisationResponse1 `xml:"urn1:AuthstnRspn", json:"AuthstnRspn", bson:"AuthstnRspn"`
...
type AcquirerAuthorisationResponse1 struct {
	XMLName *xml.Name                    `xml:"urn1:AcquirerAuthorisationResponse1", json:"-,omitempty", bson:"-,omitempty"`
	...
	Tx      *CardTransaction4            `xml:"urn1:Tx", json:"Tx", bson:"Tx"`
}
...
type CardTransaction4 struct {
	XMLName           *xml.Name               `xml:"urn1:CardTransaction4", json:"-,omitempty", bson:"-,omitempty"`
	...
	TxDtls            *CardTransactionDetail2 `xml:"urn1:TxDtls", json:"TxDtls", bson:"TxDtls"`
...
type CardTransactionAmount2 struct {
	XMLName          *xml.Name          `xml:"urn1:CardTransactionAmount2", json:"-,omitempty", bson:"-,omitempty"`
...
type CardTransactionDetail2 struct {
	XMLName      *xml.Name                         `xml:"urn1:CardTransactionDetail2", json:"-,omitempty", bson:"-,omitempty"`
	TxAmts       *CardTransactionAmount2           `xml:"urn1:TxAmts", json:"TxAmts", bson:"TxAmts"`
