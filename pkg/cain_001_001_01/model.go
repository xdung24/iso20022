...
type AcquirerAuthorisationInitiation struct {
	...
	AuthstnInitn *AcquirerAuthorisationInitiation1 `xml:"AuthstnInitn", json:"AuthstnInitn", bson:"AuthstnInitn"`
...
type AcquirerAuthorisationInitiation1 struct {
	...
	Tx      *CardTransaction15           `xml:"Tx", json:"Tx", bson:"Tx"`
}
...
type CardTransaction15 struct {
	...
	TxDtls            *CardTransactionDetail1 `xml:"TxDtls", json:"TxDtls", bson:"TxDtls"`
...
type CardTransactionDetail1 struct {
	XMLName        xml.Name                `json:"-,omitempty", bson:"-,omitempty", xml:""`
	TxAmts         *CardTransactionAmount1 `xml:"TxAmts", json:"TxAmts", bson:"TxAmts"`
