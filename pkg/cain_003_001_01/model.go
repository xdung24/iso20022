...
type AcquirerFinancialInitiation struct {
	XMLName  *xml.Name                     `xml:"urn1:AcquirerFinancialInitiation", json:"-,omitempty", bson:"-,omitempty"`
	Hdr      *Header17                     `xml:"urn1:Hdr", json:"Hdr", bson:"Hdr"`
	FinInitn *AcquirerFinancialInitiation1 `xml:"urn1:FinInitn", json:"FinInitn", bson:"FinInitn"`
...
type AcquirerFinancialInitiation1 struct {
	XMLName *xml.Name                    `xml:"urn1:AcquirerFinancialInitiation1", json:"-,omitempty", bson:"-,omitempty"`
	...
	Tx      *CardTransaction5            `xml:"urn1:Tx", json:"Tx", bson:"Tx"`
}
...
type CardTransaction5 struct {
	XMLName           *xml.Name               `xml:"urn1:CardTransaction5", json:"-,omitempty", bson:"-,omitempty"`
	...
	AcqrrTxRef        string                  `xml:"urn1:AcqrrTxRef", json:"AcqrrTxRef", bson:"AcqrrTxRef"`
	...
	TxDtls            *CardTransactionDetail3 `xml:"urn1:TxDtls", json:"TxDtls", bson:"TxDtls"`
...
type CardTransactionAmount3 struct {
	XMLName          *xml.Name          `xml:"urn1:CardTransactionAmount3", json:"-,omitempty", bson:"-,omitempty"`
...
type CardTransactionDetail3 struct {
	XMLName        *xml.Name               `xml:"urn1:CardTransactionDetail3", json:"-,omitempty", bson:"-,omitempty"`
	TxAmts         *CardTransactionAmount3 `xml:"urn1:TxAmts", json:"TxAmts", bson:"TxAmts"`
