...
type AcquirerFinancialResponse struct {
	...
	FinRspn  *AcquirerFinancialResponse1 `xml:"FinRspn", json:"FinRspn", bson:"FinRspn"`
...
type AcquirerFinancialResponse1 struct {
	...
	Tx      *CardTransaction6            `xml:"Tx", json:"Tx", bson:"Tx"`
}
...
type CardTransaction6 struct {
	...
	TxDtls            *CardTransactionDetail4 `xml:"TxDtls", json:"TxDtls", bson:"TxDtls"`
...
type CardTransactionDetail4 struct {
	XMLName      xml.Name                          `json:"-,omitempty", bson:"-,omitempty", xml:""`
	TxAmts       *CardTransactionAmount4           `xml:"TxAmts", json:"TxAmts", bson:"TxAmts"`
