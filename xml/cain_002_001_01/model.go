...
type AcquirerAuthorisationResponse struct {
	XMLName     *xml.Name                       `xml:"urn1:AcquirerAuthorisationResponse"`
	Hdr         *Header17                       `xml:"urn1:Hdr"`
	AuthstnRspn *AcquirerAuthorisationResponse1 `xml:"urn1:AuthstnRspn"`
...
type CardTransaction4 struct {
	XMLName           *xml.Name               `xml:"urn1:CardTransaction4"`
...
type CardTransactionDetail2 struct {
	XMLName      *xml.Name                         `xml:"urn1:CardTransactionDetail2"`
	TxAmts       *CardTransactionAmount2           `xml:"urn1:TxAmts"`
