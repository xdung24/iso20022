...
type AcquirerAuthorisationInitiation struct {
	XMLName      *xml.Name                         `xml:"urn1:AcquirerAuthorisationInitiation"`
	Hdr          *Header17                         `xml:"urn1:Hdr"`
	AuthstnInitn *AcquirerAuthorisationInitiation1 `xml:"urn1:AuthstnInitn"`
...
type AcquirerAuthorisationInitiation1 struct {
	XMLName *xml.Name                    `xml:"urn1:AcquirerAuthorisationInitiation1"`
	Envt    *CardTransactionEnvironment1 `xml:"urn1:Envt"`
	Cntxt   *CardTransactionContext1     `xml:"urn1:Cntxt"`
	Tx      *CardTransaction15           `xml:"urn1:Tx"`
}
...
type CardTransaction15 struct {
	XMLName           *xml.Name               `xml:"urn1:CardTransaction15"`
	...
	TxDtls            *CardTransactionDetail1 `xml:"urn1:TxDtls"`
...
type CardTransactionAmount1 struct {
	XMLName          *xml.Name          `xml:"urn1:CardTransactionAmount1"`
...
type CardTransactionDetail1 struct {
	XMLName        *xml.Name               `xml:"urn1:CardTransactionDetail1"`
	TxAmts         *CardTransactionAmount1 `xml:"urn1:TxAmts"`
